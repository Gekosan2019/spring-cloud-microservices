...
import com.javastart.notification.service.dto.DepositResponseDTO;
...
public class DepositMessageHandler {
    ...
    public void receive(Message message) throws JsonProcessingException {
        ...
        mailMessage.setFrom("Откуда пришло");

        mailMessage.setSubject("Your Deposit.");
        mailMessage.setText("Hello! Make deposit, sum: " + depositResponseDTO.getAmount());
        try {
